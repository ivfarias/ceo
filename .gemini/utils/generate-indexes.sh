...
# Usage: .agent/utils/generate-indexes.sh
...
while IFS= read -r -d '' data_file; do
    ...
    if [[ "$(basename "$data_file")" == "gemini-prompting-guide.md" ]]; then
        id="gemini-prompting-guide"
...
# ============================================================================
# Generate profiles.toml (for user's ~/.agent/config.toml)
# ============================================================================
echo ""
...
echo -e "${YELLOW}  → Copy .agent/profiles.toml to your ~/.agent/config.toml${NC}"
...
echo "  • profiles.toml (copy to ~/.agent/config.toml)"
echo "  • SETUP.md (user setup guide)"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo "  1. Review generated files"
echo "  2. Copy profiles.toml to ~/.agent/config.toml"
