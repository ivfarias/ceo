...
- **Lean PRD** (`.codex/templates/prd-tmpl.yaml`): Simple features, 1-2 page specs, clear requirements
- **Task YAML** (`.codex/tasks/*.yaml`): Procedural workflows, repeatable operations, checklists
- **Direct implementation**: Obvious bug fixes, minor changes, clear one-step tasks

### How to Create an ExecPlan

1. Use the template: `.codex/templates/execplan-tmpl.yaml`
2. Follow the requirements in: `.codex/PLANS.md`
...
For complete ExecPlan guidelines and requirements, see `.codex/PLANS.md`.
