...
# Usage: .github/utils/generate-indexes.sh
...
# DO NOT EDIT MANUALLY - Run .github/utils/generate-indexes.sh to regenerate
version: 1
agents:
EOF
...
# ============================================================================
# Generate profiles.toml (for user's ~/.github/config.toml)
# ============================================================================
echo ""
...
# ============================================================================
# Add these profiles to your ~/.github/config.toml to enable agent switching
#
# Usage:
#   copilot --profile ceo        # Start with CEO orchestrator
#   copilot --profile developer  # Start with Developer agent
#   copilot --profile pm         # Start with Product Manager
#   etc.
#
# Copy-paste this entire block into your ~/.github/config.toml file
# ============================================================================
...
echo -e "${YELLOW}  → Copy .github/profiles.toml to your ~/.github/config.toml${NC}"
...
echo "  • profiles.toml (copy to ~/.github/config.toml)"
echo "  • SETUP.md (user setup guide)"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo "  1. Review generated files"
echo "  2. Copy profiles.toml to ~/.github/config.toml"
