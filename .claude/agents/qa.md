...
- Checklists: `.claude/checklists/code-quality-checklist.yaml`, `openai-sdk-compliance-checklist.yaml`
- Data: `.claude/data/technical-preferences.yaml`
- Tasks: `.claude/tasks/nfr-assess.yaml`, `review-task.yaml`, `test-scenarios.yaml`
- Templates: `.claude/templates/qa-gate-tmpl.yaml`
