...
3. Reference frameworks (`.claude/data/marketing-frameworks.yaml`)
...
- Frameworks: `.claude/data/marketing-frameworks.yaml`
- Best practices: `.claude/data/channel-best-practices.yaml`
- Templates: `.claude/templates/marketing-strategy-tmpl.yaml`
